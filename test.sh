...
echo "Result:"
nohup java -jar ${BASH_SOURCE%/*}/app.jar -login vasya -pass 123 -role READ -res A.B &
echo $?
...
echo "Result:"
nohup java -jar ${BASH_SOURCE%/*}/app.jar -login vasya -pass 123 -role DELETE -res A.B.C &
echo $?
